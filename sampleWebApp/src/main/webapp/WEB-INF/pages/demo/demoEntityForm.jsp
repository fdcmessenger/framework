...
<s:fielderror></s:fielderror>
		<form  id="demoForm"  method="post" action="saveEntity"
...
简单类型
				...
				<dl>
					<dd>
						<s:textfield key="demoEntity.longField" name="model.longField"
							 cssClass="required"/>
					</dd>
				</dl>
				<dl>
				...
				<dl>
					<dd>
						<s:checkbox key="demoEntity.booleanField"
							name="model.booleanField" />
					</dd>
				</dl>
				<dl>
					<dd>
				...
				<dl>
					<dd>
						<s:textfield id="demoEntity_doubleField"
							key="demoEntity.doubleField" name="model.doubleField"
							 required="true" />
					</dd>
				</dl>
				</fieldset>
...
对象类型
				...
				<dl>
					<dd>
						<s:textfield key="demoEntity.longObjField"
							name="model.longObjField"
							 />
					</dd>
				</dl>
				<dl>
				...
				<dl>
					<dd>
						<s:textfield key="demoEntity.byteObjField"
							name="model.byteObjField" />
					</dd>
				</dl>
				<dl>
					<dd>
				...
				<dl>
					<dd>
						<s:textfield key="demoEntity.charObjField"
							name="model.charObjField" />
					</dd>
				</dl>
				<dl>
					<dd>
				...
				<dl>
					<dd>
						<s:textfield id="demoEntity_dateField" key="demoEntity.dateField"
							name="model.dateField" >
							<s:param name="value">
								<s:date name="model.dateField"
				...
				<dl>
					<dd>
						<s:textfield key="demoEntity.timestampField"
							name="model.timestampField">
							<s:param name="value">
								<s:date name="model.timestampField"
									format="%{getText('timestamp.format')}" />
							</s:param>
						</s:textfield>
					</dd>
				</dl>
